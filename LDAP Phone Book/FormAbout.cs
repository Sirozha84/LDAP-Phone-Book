    ...
    public partial class FormAbout : Form
    {
        public FormAbout()
        {
            ...
            history.AppendText("• Отображение прогресса загрузки данных с возможностью отмены\n" +
                ...
                "• Возможность открыть папку рабочего стола пользователя\"\n" +
                "• Возможность открыть диалог с контактом в  \"Skype для бизнеса\"\n" +
                "• Ping компьютера пользователя\n" +
                "• Загрузка данных с фильтром по определённой организации\n\n");
